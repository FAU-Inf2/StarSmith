...
/**
 * Executes the test cases for the attribute check pass.
 */
@RunWith(Parameterized.class)
public final class AttributeCheckTest {

  private static final String[] resourcePaths = {
      "/AttributeCheck/positive",
      "/AttributeCheck/negative",
  };
   ...
   */
  public AttributeCheckTest(final String resourceNameInputFile,
  ...
  /**
   * Executes a single test case for the attribute check pass.
   *
   * @throws Throwable  if something fails
   */
  @Test
  public final void testAttributeCheck() throws Throwable {
